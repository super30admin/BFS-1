# -*- coding: utf-8 -*-
"""
Created on Sun Oct 18 03:28:35 2020
...
class Solution:
    ...
    Step 6: Declare level_node which will store all the nodes for that particular level.
    Step 6: Pop the left element from the queue and store it in curr.
    Step 8: Append the value in level_nodes
    ...
    Step 8: Everytime when we are out of the for loop, append the level_nodes to the output list.
